...
public class ChildFirstUrlClassLoaderTest {
    ...
    private final static String CLASS_NAME = "com.purelypro.isolate.classloader.IsolatableClass";
    ...
    @Test
    public void isolatedClassIsNotSameAsNonIsolatedClass() throws ReflectiveOperationException {
        Class isolatedClass = isolatedClassLoader.loadClass(CLASS_NAME);
        Class nonIsolatedClass = classLoader.loadClass(CLASS_NAME);
